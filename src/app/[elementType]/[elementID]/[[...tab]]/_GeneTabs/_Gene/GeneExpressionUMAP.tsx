...
const GeneExpressionUMAP = <T extends PointMetadata, S extends true, Z extends boolean | undefined>({ geneData, selected, geneExpressionData, setSelected, ...rest }: GeneExpressionUmapProps<T, S, Z>) => {
  ...
  return (
    <>
      ...
      <Box
        padding={1}
        sx={{ position: "relative", width: "100%", height: "calc(100% - 72px)" }}

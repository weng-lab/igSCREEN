...
export type GeneQuery = { __typename?: 'Query', gene?: Array<{ __typename?: 'Gene', name: string, strand: string, coordinates: { __typename?: 'GenomicRange', chromosome: string, end: number, start: number } } | null> | null };
